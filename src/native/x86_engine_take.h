 ...
 *   X2_ENGINE_TAKE=@scratch/take.txt       one address per line, # comments
 ...
 *
 * A NAMED ADDRESS WITH NO BODY IS ALSO A REFUSAL. "Decline the body at X"
 * where nothing is at X is a typo, and honouring it as "take nothing" is the
 * failure mode that makes a run look like it measured something.
 */
