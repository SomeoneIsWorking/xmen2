...
| Browser product composition | Shared-prefix build, native worker entry, title install/launch page and explicit release resource map | `tools/build_web.py`, `cmake/WebDependencies.cmake`, `cmake/WebTarget.cmake`, `src/web/web_main.cpp`, `web/` | `build_web.py`, browser `main` | [Web release](web-release.md) |
