...
| Touch account | This run's contact, drop, routing and pad-publication counts and the text made from them; a run in which nothing happened names which nothing it was | `src/input/touch_census.{h,cpp}` | `x2_touch_census`, `x2_touch_census_report` | [Touch play](touch-play.md) |
