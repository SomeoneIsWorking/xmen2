...
| Conversation and cutscene input | Bridge the retail conversation manager and own cutscene-skip classification, publication, and probes | `src/native/conversation.c`, `src/native/conversation_cutscene_skip.c`, `src/native/conversation_skip_policy.c`, `src/native/cutscene_skip_publication.c` | override registration in `conversation.c` | external Alchemy conversation notes |
