...
| Runtime execution engine | Run guest code the recompiler never translated: engine selection, the substrate/x86port state bridge, the return trampoline, and the call-out back to the dispatcher | `src/native/x86_engine.c`, `shared/x86port` (consumed) | `x2_engine_init`, `x2_engine_call`, `x2_engine_selftest` | [jit-common I004](../../../shared/jit-common/docs/issues/I004-xmen2-runtime-execution-entry-conditions.md) |
