...
disassembly at 0x67217c matches the canonical _ftol2 CW-independent float->int64 truncation pattern; crt_in_image_overrides unit test proves trunc-toward-zero + edx:eax + cdecl esp; driven in-game run 2026-09-03 (scratch/logs/ftol2_on.log): 'overrides: 80 bound', no resolve abort, 0x006721xx absent from top-40 execution-weighted blocks (was #8-11 ~2.8%), gameplay screenshot correct
