...
static uint32_t read_fixture(void *context, uint32_t address)
{
    ...
    reads++;
    switch (address) {
    case 0x1000: return words[0];
    case 0x2000: return words[1];
    case 0x3060: return words[2];
    default: failures++; return 0;
    }
}
...
int main(void)
{
    ...
    reads = 0;
    check(x86_memwatch_read(&watch, 0x1000, read_fixture, fixture,
                            &address, &value),
