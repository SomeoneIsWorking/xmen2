...
int main(void)
{
    ...
    duplicate = x2_fmv_timestamp(&timeline, 0, no_timestamp,
                                 1, 90000, 3000);
    fallback = x2_fmv_timestamp(&timeline, no_timestamp, no_timestamp,
                                1, 90000, 3000);
    clamped = x2_fmv_timestamp(&timeline, 0, no_timestamp, 1, 90000, 3000);
    later = x2_fmv_timestamp(&timeline, 18000, no_timestamp,
                             1, 90000, 3000);
