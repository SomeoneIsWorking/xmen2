...
static const struct {
    ...
    { "rol.b", X86_ROL, 1, host_rolb_8 },
    { "ror.b", X86_ROR, 1, host_rorb_8 },
    { "rcl.b", X86_RCL, 1, host_rclb_8 },
    { "rcr.b", X86_RCR, 1, host_rcrb_8 },
    { "rol.w", X86_ROL, 2, host_rolw_16 },
    { "ror.w", X86_ROR, 2, host_rorw_16 },
    { "rcl.w", X86_RCL, 2, host_rclw_16 },
    { "rcr.w", X86_RCR, 2, host_rcrw_16 },
    { "rol.l", X86_ROL, 4, host_roll_32 },
    { "ror.l", X86_ROR, 4, host_rorl_32 },
    { "rcl.l", X86_RCL, 4, host_rcll_32 },
    { "rcr.l", X86_RCR, 4, host_rcrl_32 },
};

static const uint32_t VALS[] = {
    0x00000000u, 0xFFFFFFFFu, 0x00000001u, 0x80000000u, 0x12345678u,
    0xDEADBEEFu, 0x0000FF01u, 0x80000001u,
};
