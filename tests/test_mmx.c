...
static const uint64_t A[] = {
    ...
    0xFFFF80007FFF0001ULL,
    0x8081FE7F01800000ULL,
    0x0000000000000000ULL,
    0x7F7F7F7F80808080ULL,
    0xDEADBEEFCAFEBABEULL,
};
static const uint64_t B[] = {
    0x0004000300020001ULL,
    0x00017FFF8000FFFFULL,
    0x7F01FF80007FFFFEULL,
...
int main(void)
{
    ...
    for (i = 0; i < NPAIR; i++) {
        ...
        chk("punpcklbw", mmx_punpcklbw(A[i], B[i]),
            lo64(_mm_unpacklo_epi8(a, b)));
        chk("punpcklwd", mmx_punpcklwd(A[i], B[i]),
            lo64(_mm_unpacklo_epi16(a, b)));
        chk("punpckldq", mmx_punpckldq(A[i], B[i]),
            lo64(_mm_unpacklo_epi32(a, b)));
