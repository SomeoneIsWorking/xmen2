#!/usr/bin/env python3
"""recomp_hosted — shared x86 translator toolchain, run from this port.
...
_tool = os.path.join(shared_dir("recomp-x86", "tools/recomp_hosted.py"), "tools", "recomp_hosted.py")
