#!/usr/bin/env python3
"""seed_code_imms — shared x86 translator toolchain, run from this port.
...
_tool = os.path.join(shared_dir("recomp-x86", "tools/seed_code_imms.py"), "tools", "seed_code_imms.py")
