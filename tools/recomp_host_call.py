#!/usr/bin/env python3
"""recomp_host_call — shared x86 translator toolchain, run from this port.
...
_tool = os.path.join(shared_dir("recomp-x86", "tools/recomp_host_call.py"), "tools", "recomp_host_call.py")
