#!/usr/bin/env python3
"""whose_function — shared x86 translator toolchain, run from this port.
...
_tool = os.path.join(shared_dir("recomp-x86", "tools/whose_function.py"), "tools", "whose_function.py")
