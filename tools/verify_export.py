#!/usr/bin/env python3
"""verify_export — shared x86 translator toolchain, run from this port.
...
_tool = os.path.join(shared_dir("recomp-x86", "tools/verify_export.py"), "tools", "verify_export.py")
