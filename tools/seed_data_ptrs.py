#!/usr/bin/env python3
"""seed_data_ptrs — shared x86 translator toolchain, run from this port.
...
_tool = os.path.join(shared_dir("recomp-x86", "tools/seed_data_ptrs.py"), "tools", "seed_data_ptrs.py")
